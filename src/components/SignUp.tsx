 ...
 *
 * Kaparehas ng structure ng SignIn.tsx:
 *   - c-hub5.png buong-screen na LIKOD (dumudulas PABABA).
 *   - White form card na may SAD CURVE sa TOP edge (arch ⌢), dumudulas PAITAAS.
 *   - Branding sa itaas: logo/C-HUB, "Welcome", "Create account to continue shopping."
 *
 * Transition papasok: pag-click ng "Sign up" sa SignIn, ang SignIn ay mae-exit
 * PATALON (magslide pababa) at ang SignUp na ito ay papasok PAITAAS.
 * Pag natapos ang signup, babalik sa SignIn.
 */
    ...
    >
      ...
      <div className="md:hidden relative flex flex-col flex-1 min-h-0">
        ...
        <div className="absolute inset-x-0 top-0 z-10 flex flex-col items-center text-center px-8 pt-12 pointer-events-none">
          ...
          <p className="mt-1 text-xs text-stone-600">Create account to continue shopping.</p>
        </div>
        ...
        >
          ...
          <div className="relative bottom-12 z-10">
            ...
            <p className="mt-6 text-sm text-stone-500">
              ...
              <button onClick={() => setPage('signin')} className="text-indigo-600 font-black underline underline-offset-2">
                Sign in
              </button>
            </p>
